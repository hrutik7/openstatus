...
3. Then download this file  [ping_response__v3](https://docs.openstatus.dev/dummy/ping_response__v3.csv)
...
6. Create pipe from the datasource name as a `response_list__v0` and `monitor_list__v0` 

7. Inside `response_list__v0` pipe, create a endpoint by running a following query :
...
8. Inside `monitor_list__v0` pipe , create a endpoint by running a following query :
